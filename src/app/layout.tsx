          ...
          <div className="container mx-auto px-4">
            <div className="flex items-center justify-between h-16">
              ...
              <nav className="hidden md:flex items-center gap-6">
                <Link href="/profesionales" className="text-slate-600 hover:text-pink-600 font-medium transition-colors">
                  Modelos
                </Link>
            ...
            <div className="grid grid-cols-2 md:grid-cols-4 gap-8 mb-8">
              <div>
                ...
                <ul className="space-y-2">
                  <li><Link href="/profesionales" className="text-pink-200/80 hover:text-white transition-colors">Buscar Modelos</Link></li>
              ...
              <div>
                ...
                <ul className="space-y-2">
                  <li><Link href="/register" className="text-pink-200/80 hover:text-white transition-colors">Registrarse</Link></li>
              ...
              <div>
                ...
                <ul className="space-y-2">
                  <li><Link href="/legal/terminos" className="text-pink-200/80 hover:text-white transition-colors">Términos</Link></li>
                  <li><Link href="/legal/privacidad" className="text-pink-200/80 hover:text-white transition-colors">Privacidad</Link></li>
                  <li><Link href="/legal/cookies" className="text-pink-200/80 hover:text-white transition-colors">Cookies</Link></li>
                </ul>
              </div>
            </div>
